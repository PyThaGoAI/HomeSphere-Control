      ...
      <div className="flex flex-col space-y-6">
        <div className="flex items-center">
          ...
          <div className="ml-auto flex space-x-3">
            <button 
              className={`px-4 py-2 rounded-lg transition-colors ${timeRange === 'daily' ? 'bg-cosmic-teal/30 text-cosmic-teal' : 'bg-cosmic-blue/50 hover:bg-cosmic-blue/70'}`}
              onClick={() => setTimeRange('daily')}
            >
              Daily
            </button>
            <button 
              className={`px-4 py-2 rounded-lg transition-colors ${timeRange === 'weekly' ? 'bg-cosmic-teal/30 text-cosmic-teal' : 'bg-cosmic-blue/50 hover:bg-cosmic-blue/70'}`}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          <div className="p-6 bg-cosmic-blue/30 backdrop-blur-md border border-cosmic-teal/20 rounded-xl flex items-center">
            <div className="w-16 h-16 rounded-full bg-cosmic-blue/60 flex items-center justify-center">
              <div className="w-10 h-10 rounded-full bg-cosmic-teal animate-pulse-glow"></div>
            </div>
            <div className="ml-4">
              <div className="text-sm text-white/70">Current Usage</div>
              <div className="text-2xl font-orbitron">1.2 kW</div>
            </div>
          </div>
          
          <div className="p-6 bg-cosmic-blue/30 backdrop-blur-md border border-cosmic-teal/20 rounded-xl flex items-center">
            <div className="w-16 h-16 rounded-full bg-cosmic-blue/60 flex items-center justify-center">
              <div className="w-10 h-10 rounded-full bg-cosmic-amber"></div>
            </div>
            <div className="ml-4">
              <div className="text-sm text-white/70">{timeRange === 'daily' ? "Today's Total" : "Weekly Total"}</div>
              <div className="text-2xl font-orbitron">{timeRange === 'daily' ? "15.8" : "98.4"} kWh</div>
            </div>
          </div>
          ...
          <div className="p-6 bg-cosmic-blue/30 backdrop-blur-md border border-cosmic-teal/20 rounded-xl flex items-center">
            ...
            <div className="ml-4">
              ...
              <div className="text-2xl font-orbitron">${timeRange === 'daily' ? "3.95" : "24.60"}</div>
            </div>
          </div>
          
          <div className="p-6 bg-cosmic-blue/30 backdrop-blur-md border border-cosmic-teal/20 rounded-xl flex items-center">
            <div className="w-16 h-16 rounded-full bg-cosmic-blue/60 flex items-center justify-center">
              <div className="w-10 h-10 rounded-full bg-cosmic-teal/60"></div>
            </div>
            <div className="ml-4">
              <div className="text-sm text-white/70">Average</div>
              <div className="text-2xl font-orbitron">{timeRange === 'daily' ? "1.3" : "14.0"} kWh</div>
            </div>
          </div>
        </div>
        
        <div className="p-6 bg-cosmic-blue/30 backdrop-blur-md border border-cosmic-teal/20 rounded-xl">
          <h2 className="font-orbitron text-lg mb-4">Energy Consumption</h2>
          <div className="h-64">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="p-6 bg-cosmic-blue/30 backdrop-blur-md border border-cosmic-teal/20 rounded-xl">
            <h2 className="font-orbitron text-lg mb-4">Device Usage</h2>
            <div className="space-y-3">
              {[
                ...
                <div key={device.device} className="flex items-center">
                  <span className="text-sm w-44">{device.device}</span>
                  <div className="flex-1 mx-4 h-2 bg-cosmic-blue/50 rounded-full overflow-hidden">
                    <div 
                      className="h-full bg-cosmic-teal"
                      style={{ width: `${device.percentage}%` }}
                    ></div>
                  </div>
                  <span className="text-sm text-white/70">{device.usage} kWh</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="p-6 bg-cosmic-blue/30 backdrop-blur-md border border-cosmic-teal/20 rounded-xl">
            <h2 className="font-orbitron text-lg mb-4">Energy Saving Tips</h2>
            <div className="space-y-4">
              {[
                ...
                <div key={index} className="p-3 bg-cosmic-blue/40 rounded-lg flex items-center">
